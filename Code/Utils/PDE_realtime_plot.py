...
class PDE_realtime_plot:
    def __init__(self, location_figures, uh, epsilon, fs):
        self.PLOT_SOL = False
        self.uh = uh
        ...
        if self.PLOT_SOL:
            ...
            self.plotter = pyvista.Plotter(shape=(1, 2), off_screen=False, window_size=[1600, 800])
    ...
    def update_plot(self, uh, epsilon):
        self.uh = uh
        self.epsilon = epsilon
        if self.PLOT_SOL:
