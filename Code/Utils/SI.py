...
class SI:
    ...
    def get_epsilon_nonlinear(self, velocity_field, node_patches, h_CG, u_n, stiffness_matrix, plot_func, degree=1):
    ...
    # def get_epsilon_linear(self, w, node_patches, h_CG, u_n, stiffness_matrix, plot_func, degree=1):
    #     V = fem.functionspace(self.domain, ("Lagrange", degree))
    #     epsilon = fem.Function(V)
    #     for node, adjacent_nodes in node_patches.items():
    #         # node = i and adjacent_nodes (including self) = j
    ...
    # def get_alpha_nonlinear(self, velocity_field, node_patches, h_CG, u_n, stiffness_matrix, plot_func, degree=1):
    #     # Create a function to store epsilon
    #     V = fem.functionspace(self.domain, ("Lagrange", degree))
