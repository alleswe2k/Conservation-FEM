...
pde = PDE_solver()
PLOT = False
location_data = "Code/Burgers_equation/Data/RV/solution.xdmf"
location_figures = "Code/Burgers_equation/Figures/RV"
...
pde.plot_2d(domain, 100, u_n, 'u_n', 'init_2d', location=location_figures)
...
if PLOT:
    ...
    plotter.open_gif(location_figures, fps=10)
...
pde.plot_solution(domain, 100, u_exact, "exact_solution", "Exact Solution", location_figures)

pde.plot_solution(domain, 100, u_exact, "initial_exact", "Initial Exact", location_figures)

pde.plot_2d(domain, 100, epsilon, 'Epsilon', 'epsilon_2d', location=location_figures)
pde.plot_2d(domain, 100, RH, 'RH', 'rh', location=location_figures)
pde.plot_2d(domain, 100, u_n, 'u_n', 'sol_2d', location=location_figures)
pde.plot_2d(domain, 100, u_exact, 'u_exact', 'u_exact_2d', location=location_figures)
