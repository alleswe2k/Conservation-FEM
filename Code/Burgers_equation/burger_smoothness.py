...
pde.plot_2d(domain, 100, epsilon, 'Epsilon Burger', 'epsilon_2d_burger', location=location_figures)

pde.plot_solution(domain, 100, u_exact, "exact_solution", "Exact Solution", location=location_figures)

u_exact.interpolate(initial_condition)
pde.plot_solution(domain, 100, u_exact, "initial_exact", "Initial Exact", location=location_figures)
