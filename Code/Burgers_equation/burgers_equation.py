...
a = -u * v *ufl.dx - 0.5 * dt * ufl.grad(u) * v * ufl.dx - 0.5 * dt * eps * ufl.grad(u) * grad(v) * ufl.dx
L = -u_n * v *ufl.dx + 0.5 * dt * ufl.grad(u_n) * v * ufl.dx + 0.5 * dt * eps * ufl.grad(u_n) * grad(v) * ufl.dx
