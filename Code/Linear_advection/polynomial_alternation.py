...
xdmf_sol = io.VTXWriter(domain.comm, f"{location_data}/sol_discont_D{degree}.bp", epsilon, engine="BP4")
# xdmf_sol = io.XDMFFile(domain.comm, f"{location_data}/sol_discont_D{degree}.xdmf", "w")
# xdmf_sol.write_mesh(domain)
# xdmf_eps = io.XDMFFile(domain.comm, f"{location_data}/eps_discont_D{degree}.xdmf", "w")
xdmf_eps = io.VTXWriter(domain.comm, f"{location_data}/eps_discont_D{degree}.bp", uh, engine="BP4")
