...
pde.plot_pv(domain, mesh_size, uh, 'Initial condition', 'init_discont_cont_IC', location_figures, plot_2d=True)
pde.plot_pv(domain, mesh_size, uh, 'Initial condition', 'init_discont_cont_IC_3d', location_figures)
...
pde.plot_pv(domain, mesh_size, uh, 'Solution 2d', 'lin_adv_sol_discont_IC', location_figures, plot_2d=True)
pde.plot_pv(domain, mesh_size, uh, 'Solution 3d', 'lin_adv_sol_discont_IC_3d', location_figures)
