...
location_figures = os.path.join(script_dir, f"Figures/SI")
location_data = os.path.join(script_dir, f"Data/SI")
...
for degree in degrees:
    ...
    for fraction in fractions:
        ...
        for i in tqdm(range(num_steps)):
            ...
            epsilon = si.get_epsilon_linear(w, h_CG, u_n, stiffness_matrix, degree)
            ...
            epsilon = si.get_epsilon_linear(w, h_CG, u_tmp, stiffness_matrix, degree)
