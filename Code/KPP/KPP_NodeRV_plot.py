...
PLOT = False
location_data = "Code/KPP/Data/SI/solution.xdmf"
location_figures = "Code/KPP/Figures/SI"

gmsh.initialize()

membrane = gmsh.model.occ.addRectangle(-2,-2.5,0,4,4)
...
pde_solve.plot_solution(domain, RH, 'RH_plot32', 'RH')
pde_solve.plot_solution(domain, epsilon, 'epsilon32', 'Epsilon')
pde_solve.plot_solution(domain, uh, 'uh_plot32', 'Uh')