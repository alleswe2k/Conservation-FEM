...
if PLOT:
    ...
    plotter.open_gif("./Figures/KPP.gif", fps=10)
...
location="./Figures"
pde.plot_2d(domain, 100, epsilon, 'Espilon', 'KPP_epsilon_2d', location=location)
pde.plot_2d(domain, 100, RH, 'RH', 'KPP_rh_2d', location=location)